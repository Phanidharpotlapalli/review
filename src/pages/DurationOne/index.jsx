...
const DurationOnePage = () => {
  ...
  const tableColumns = React.useMemo(() => {
    ...
    return [
      ...
      tableColumnHelper.accessor("joiningtime", {
        cell: (info) => (
          <Text
      ...
      tableColumnHelper.accessor("leavingtime", {
        cell: (info) => (
          <Text
            className="pb-3.5 sm:pl-5 pl-[35px] pt-8 sm:text-[24.55px] md:text-[26.55px] text-[28.55px] text-white-A700"
            size="txtPoppinsRegular2855"
      ...
      tableColumnHelper.accessor("totaltime", {
        cell: (info) => (
          <Text
        ...
        <div className="flex md:flex-col flex-row md:gap-10 gap-[67px] items-start justify-start w-[97%] md:w-full">
          ...
          <div className="flex flex-col items-center justify-start md:mt-0 mt-[61px] w-[83%] md:w-full">
            ...
            <div className="flex flex-col items-center justify-start w-full">
              ...
              <div className="bg-gray-900_bf border border-gray-400 border-solid flex flex-col font-poppins items-center justify-start p-7 sm:px-5 rounded-bl-[40px] rounded-br-[40px] w-full">
              ...
              <div className="bg-blue_gray-100_21 flex sm:flex-col flex-row sm:gap-5 items-center justify-start mt-[23px] p-[19px] rounded-[12px] w-full">
                <Text
                  className="ml-8 sm:ml-[0] text-3xl sm:text-[26px] md:text-[28px] text-white-A700"
                  size="txtKollektifBold30WhiteA700"
                >
                  Jane Smith
                </Text>
              ...
              <div className="bg-blue_gray-100_21 flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[26px] p-[17px] rounded-[12px] w-full">
                <Text
                ...
                <Img
                  className="common-pointer h-[50px] md:h-auto md:ml-[0] ml-[25px] mr-2.5 object-cover w-[50px]"
                  src="images/img_arrowdownsigntonavigate_32x32.png"
                  alt="arrowdownsignto_One"
                  onClick={() => navigate("/duration")}
                />
              </div>
              <div className="bg-blue_gray-100_21 flex sm:flex-col flex-row sm:gap-5 items-center justify-start mt-[22px] p-[19px] rounded-[12px] w-full">
                <Text
...
export default DurationOnePage;
